...
public extension CFFmpeg.AVFieldOrder {
    static let UNKNOWN = AV_FIELD_UNKNOWN

    static let PROGRESSIVE = AV_FIELD_PROGRESSIVE

    /// Top coded_first, top displayed first
    static let TT = AV_FIELD_TT

    /// Bottom coded first, bottom displayed first
    static let BB = AV_FIELD_BB

    /// Top coded first, bottom displayed first
    static let TB = AV_FIELD_TB
