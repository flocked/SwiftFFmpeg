...
extension AVPacket.Flag: CustomStringConvertible, CustomDebugStringConvertible {
    ...
    private static let names: [Self: (swift: String, native: String)] = [
        .key: ("key", "AV_PKT_FLAG_KEY"),
        .corrupt: ("corrupt", "AV_PKT_FLAG_CORRUPT"),
        .discard: ("discard", "AV_PKT_FLAG_DISCARD"),
        .trusted: ("trusted", "AV_PKT_FLAG_TRUSTED"),
        .disposable: ("disposable", "AV_PKT_FLAG_DISPOSABLE"),
    ]
}
...
public enum AVPacketSideDataType: UInt32 {
    ...
    /**
     HDR dynamic metadata for SMPTE ST 2094-50, Application 5.

     The metadata is in the form of an `AVDynamicHDRVivid` struct.
     */
    case dynamicHDRSMPTE2094App5

    /**
     HEVC decoder configuration record.

     The metadata is in the form of an `HEVCDecoderConfigurationRecord` as defined by ISO/IEC 14496-15.
     */
    case hevcConfig
