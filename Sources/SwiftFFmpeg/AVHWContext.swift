...
public extension AVCodecHWConfig {
    /// Flags used by `methods`.
    struct Method: OptionSet, Hashable {
        ...
        private static let names: [Self: (swift: String, native: String)] = [
            Self.internal: ("internal", "AV_CODEC_HW_CONFIG_METHOD_INTERNAL"),
            .adHoc: ("adHoc", "AV_CODEC_HW_CONFIG_METHOD_AD_HOC"),
            .hwDeviceContext: ("hwDeviceContext", "AV_CODEC_HW_CONFIG_METHOD_HW_DEVICE_CTX"),
            .hwFramesContext: ("hwFramesContext", "AV_CODEC_HW_CONFIG_METHOD_HW_FRAMES_CTX"),
        ]
    }
}

extension AVCodecHWConfig.Method: CustomStringConvertible, CustomDebugStringConvertible {
    public var description: String {
...
public extension AVFrame {
    ...
    var hwFramesContext: AVHWFramesContext? {
