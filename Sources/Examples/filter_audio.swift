...
private let channelLayout = AVChannelLayout.fivePointZero
...
func filter_audio() throws {
  ...
  let args =
    "sample_fmts=\(AVSampleFormat.int16.name!):sample_rates=44100:channel_layouts=\(AVChannelLayout.stereo)"
